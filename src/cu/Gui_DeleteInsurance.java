 ...
 * @author WIndows 11
 */
public class Gui_DeleteInsurance extends javax.swing.JFrame {

    /**
     * Creates new form Gui_DeleteInsurance
     */
    public Gui_DeleteInsurance() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Gui_CarDelete CD = new Gui_CarDelete();
        CD.setVisible(true);
        CD.pack();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Gui_FullDelete FD = new Gui_FullDelete();
        FD.setVisible(true);
        FD.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gui_DeleteInsurance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gui_DeleteInsurance().setVisible(true);
            }
        });
    }
